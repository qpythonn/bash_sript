# This is a small macro to list all the file contained in a directory.
#Syntax:
# source listOfFiles.sh arg1 arg2
# arg1 is the path to the directory in which we want to ls
# arg2 is an optionnal argument allowing to search for file containing "arg2" in their nams 
#
